/**
  \file G3D-base.lib/source/Welder.cpp
...
#include "G3D-base/Stopwatch.h" // for profiling
    ...
    *this = Settings();
    ...
    for (Any::AnyTable::Iterator it = any.table().begin(); it.isValid(); ++it) {
        ...
        if (key == "normalsmoothingangle") {
            ...
            any.verify(false, "Illegal key in Welder::Settings: " + it->key);
        }
    }
}
