/**
  \file G3D-base.lib/source/prompt.cpp
...
#    include "G3D-base/prompt_cocoa.h"
...
static int guiPrompt
    ...
    *pNew = '\0';
    ...
    int ret = (int)DialogBoxIndirectParam(module, dialogTemplate, nullptr, (DLGPROC)PromptDlgProc, (LPARAM)&params);
