/**
  \file G3D-base.lib/source/Intersect.cpp
...
bool Intersect::rayAABox(const PrecomputedRay& ray, const AABox& box) {
...
bool Intersect::rayAABox(const PrecomputedRay& ray, const AABox& box, float& time) {
