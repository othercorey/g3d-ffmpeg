/**
  \file G3D-base.lib/include/G3D-base/BinaryOutput.h
...
public:
    ...
    */
    ...
    /**
     Write a nullptr-terminated string with a 32-bit length field in front
     of it.  The nullptr character is included in the length count.
     */
