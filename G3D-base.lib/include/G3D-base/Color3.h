/**
  \file G3D-base.lib/include/G3D-base/Color3.h
...
public:
    ...
    /** A radiance value that will look approximately like the 
        stimulus based on the wavelength of light in nanometers.

        Remember to convert to sRGB if displaying directly.

       \cite http://www.physics.sfasu.edu/astro/color/spectra.html
       */
