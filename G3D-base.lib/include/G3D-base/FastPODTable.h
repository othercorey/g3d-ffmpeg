/**
  \file G3D-base.lib/include/G3D-base/FastPODTable.h
...
/** 
    \brief  Implemented with an open-addressing hash table
...
public:
    ...
    void clear(int newExpectedSize = -1) {
        ...
        if (newExpectedSize > 0) {
             m_initialSlots = ceilPow2(unsigned(newExpectedSize * SLOTS_PER_ENTRY));
        }
    ...
    */
    ...
    private:
        ...
        ConstIterator(const MyType* table) : IteratorBase(const_cast<MyType*>(table)) {}
