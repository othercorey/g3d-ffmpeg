/**
  \file G3D-base.lib/include/G3D-base/debugAssert.h

  \cite John Robbins, Microsoft Systems Journal Bugslayer Column, Feb 1999. <A HREF="http://msdn.microsoft.com/library/periodic/period99/feb99_BUGSLAYE_BUGSLAYE.htm">http://msdn.microsoft.com/library/periodic/period99/feb99_BUGSLAYE_BUGSLAYE.htm</A>
  \cite Douglas Cox, An assert() Replacement, Code of The Day, flipcode, Sept 19, 2000 <A HREF="http://www.flipcode.com/cgi-bin/msg.cgi?showThread=COTD-AssertReplace&forum=cotd&id=-1">http://www.flipcode.com/cgi-bin/msg.cgi?showThread=COTD-AssertReplace&forum=cotd&id=-1</A>
...
#    define debugAssert(exp) debugAssertM(exp, G3D::String("Debug assertion failure"))
    ...
    #define alwaysAssertM(exp, message) { \
        if (!(exp)) { \
            G3D::_internal::_releaseInputGrab_(); \
            if ((G3D::_internal::_failureHook != nullptr) && \
...
namespace G3D {  namespace _internal {
...
#ifdef G3D_LINUX
    /**
     A pointer to the X11 display.  Initially nullptr.  If set to a
    ...
    /**
     A pointer to the X11 window.  Initially nullptr.  If set to a
     non-null value (e.g. by SDLWindow), debugAssert attempts to use
