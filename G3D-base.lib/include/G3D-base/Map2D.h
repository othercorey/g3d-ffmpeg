/**
  \file G3D-base.lib/include/G3D-base/Map2D.h
...
DECLARE_COMPUTE_TYPE( Color3unorm8,  Color3)

DECLARE_COMPUTE_TYPE( Color4,  Color4)
DECLARE_COMPUTE_TYPE( Color4unorm8,  Color4)
...
protected:
    ...
    /** false if no mutating method has been invoked 
...
protected:
    ...
    Map2D(int w, int h, WrapMode wrap, int d = 1) : w(0), h(0), d(1), m_wrapMode(wrap), m_changed(true) {
