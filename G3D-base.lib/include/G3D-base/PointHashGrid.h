/**
  \file G3D-base.lib/include/G3D-base/PointHashGrid.h
...
public:
    ...
    */
    ...
    private:
        ...
        Iterator() : m_isEnd(true), m_grid(nullptr), m_tableIterator(CellTable().end()), 
    ...
    */
    ...
    private:
        ...
        void advanceCell() {
            ...
            } while ((m_cell == nullptr) || (m_cell->size() == 0));
        }
        ...
        void advance() {
            ...
            do {
                ++m_arrayIndex;
                bool inConstructor = (m_cell == nullptr);
        ...
        /** End iterator */
        BoxIterator() : m_isEnd(true), m_grid(nullptr), m_exact(true), m_current(0,0,0), m_cell(nullptr), m_arrayIndex(0), m_epoch(0) {}
    ...
    */
    ...
    void getIntersectingMembers(const Sphere& sphere, Array<Value>& result) const {
        for (SphereIterator it = begin(sphere); it.isValid(); ++it) {
            result.append(*it);
        }
    }
