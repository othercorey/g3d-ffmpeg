/**
  \file G3D-base.lib/include/G3D-base/BinaryFormat.h
...
enum BinaryFormat {
    ...
    VECTOR4_BINFMT, VECTOR4INT16_BINFMT, VECTOR4UINT16_BINFMT,
    COLOR3_BINFMT, COLOR3UNORM8_BINFMT, COLOR3INT16_BINFMT,
    COLOR4_BINFMT, COLOR4UNORM8_BINFMT, COLOR4INT16_BINFMT,
...
DECLARE_BINARYFORMATOF( Vector4uint16, VECTOR4UINT16_BINFMT)

DECLARE_BINARYFORMATOF( Color3,        COLOR3_BINFMT )
DECLARE_BINARYFORMATOF( Color3unorm8,  COLOR3UNORM8_BINFMT )
DECLARE_BINARYFORMATOF( Color4,        COLOR4_BINFMT )
DECLARE_BINARYFORMATOF( Color4unorm8,  COLOR4UNORM8_BINFMT )
