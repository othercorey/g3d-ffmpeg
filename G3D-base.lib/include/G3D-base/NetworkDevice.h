/**
  \file G3D-base.lib/include/G3D-base/NetworkDevice.h
...
class TextOutput;
/**  \deprecated */
class [[deprecated]] Conduit : public ReferenceCountedObject {
protected:
...
/**
 ...
 counted pointer to nullptr to disconnect.
 ...
 \deprecated
 */
class[[deprecated]] ReliableConduit : public Conduit {
private:
    friend class NetworkDevice;
    friend class NetListener;
...
<LI> When done, simply set the G3D::LightweightConduitRef to nullptr or let 
...
\deprecated
 */
class[[deprecated]] LightweightConduit : public Conduit {
private:
    friend class NetworkDevice;
...
/**
 ...
 \deprecated
 */
class[[deprecated]] NetListener : public ReferenceCountedObject {
private:
...
public:
    ...
    /** Block until a connection is received.  Returns nullptr if 
