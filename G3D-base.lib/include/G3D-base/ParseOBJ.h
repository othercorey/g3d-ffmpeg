/**
  \file G3D-base.lib/include/G3D-base/ParseOBJ.h
...
//        Sampler        sampler;
        ...
        bool operator==(const Options& other) const {
            return (texCoord1Mode == other.texCoord1Mode) &&
                (stripRefraction == other.stripRefraction) &&
                (forceMaterialsWhite == other.forceMaterialsWhite) &&
                (materialOptions == other.materialOptions);
        }
    };
