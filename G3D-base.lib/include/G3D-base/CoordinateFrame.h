/**
  \file G3D-base.lib/include/G3D-base/CoordinateFrame.h
...
template<>
struct HashTrait<G3D::CoordinateFrame> {
    static size_t hashCode(const G3D::CoordinateFrame& c) { 
        return c.rightVector().hashCode() ^ c.lookVector().hashCode() ^ c.translation.hashCode();
    }
};
