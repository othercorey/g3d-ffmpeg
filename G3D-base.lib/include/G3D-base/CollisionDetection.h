/**
  \file G3D-base.lib/include/G3D-base/CollisionDetection.h

  \cite Spherical collision and bounce direction based on Paul Nettle's ftp://ftp.3dmaileffects.com/pub/FluidStudios/CollisionDetection/Fluid_Studios_Generic_Collision_Detection_for_Games_Using_Ellipsoids.pdf and comments by Max McGuire.  Ray-sphere intersection by Eric Haines.
  \cite Box-Box intersection written by Kevin Egan.
  \cite Box-Triangle by Tomas Akenine-Moller
