/**
  \file G3D-base.lib/include/G3D-base/RegistryUtil.h
...
public:
    ...
    /** 
      ...
      @beta
      @param data pointer to the output buffer of sufficient size. Pass nullptr as data in order to have available data size returned in dataSize.
      @param dataSize size of the output buffer.  When nullptr is passed for data, contains the size of available data on successful return.
    */
