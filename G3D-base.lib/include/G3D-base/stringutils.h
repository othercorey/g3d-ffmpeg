/**
  \file G3D-base.lib/include/G3D-base/stringutils.h
...
/** Compares a < b ignoring case, but puts names beginning with "G3D" first in a sort. \sa Array::sort */
...
/** Number of new lines in the given string (handles <code>\\r\\n</code> and <code>\\n</code>). */
...
/** Splits string at new lines (handles <code>\\r\\n</code> and <code>\\n</code>).
