/**
  \file G3D-gfx.lib/include/G3D-gfx/GLCaps.h
...
#ifndef G3D_gfx_GLCaps_h
#define G3D_gfx_GLCaps_h
...
// MacOS defines INTEL and it conflicts with GLCaps::INTEL
#ifdef INTEL
#undef INTEL
#endif
...
private:
    ...
    static float        m_glVersionNumber;
...
#undef DECLARE_EXT
    ...
    static OSWindow::Settings::API s_api;
    ...
    */
    static void loadExtensions(class Log* debugLog = nullptr);
...
public:
    ...
    /** Returns the first element of \a prefs for which
        supportsTexture() returns true. Returns nullptr if none are
        supported.*/
