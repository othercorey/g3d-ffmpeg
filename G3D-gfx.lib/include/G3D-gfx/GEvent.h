/**
  \file G3D-gfx.lib/include/G3D-gfx/GEvent.h
...
private:
    static const char* toString(int i, Value& v) {
        static const char* str[] = {"RELEASED", "PRESSED", nullptr};
...
private:
    ...
    static const char* toString(int i, Value& v) {
        static const char* str[] = {"NONE", "LSHIFT", "RSHIFT", "LCTRL", "RCTRL", "LALT", "RALT", "LMETA", "RMETA", "NUM", "CAPS", "MODE", "RESERVED", "CTRL", "SHIFT", "ALT", "META", nullptr};
...
public:
    ...
    bool isGuiEvent() const {
        return (value >= GUI_DOWN) && (value <= GUI_KEY_FOCUS);
    }
};
...
public:
    /** GEventType::MOUSE_BUTTON_DOWN, GEventType::MOUSE_BUTTON_UP, or GEventType::MOUSE_BUTTON_CLICK */
    uint8                   type;
    ...
    /* For GEventType::MOUSE_BUTTON_CLICK, this is numClicks.
       For GEventType::MOUSE_BUTTON_DOWN or GEventType::MOUSE_BUTTON_UP, this is 
