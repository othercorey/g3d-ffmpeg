/**
  \file G3D-gfx.lib/include/G3D-gfx/RenderDevice.h
...
#ifndef G3D_gfx_RenderDevice_h
#define G3D_gfx_RenderDevice_h
...
private:
    ...
    bool                         m_deleteWindow; //WINDOWCHANGE
...
public:
    ...
    /** RenderDevice active on this thread, nullptr if there is not one.  By default, G3D creates a single RenderDevice on the main thread.
...
public:
    ...
    */
    ...
    /**  Set OSWindow::Settings::debugContext = true and then set
    ...
    /** \param format If nullptr, defaults to texture->format() */
    ...
    /**
     ...
     be specified.  If framebuffer() is non-nullptr then the drawBuffer
    ...
    */
    ...
    /** \brief True if the Y-axis has been flipped from the G3D convention, which occurs when the framebuffer is nullptr.
...
public:
    ...
    /**
     Sets the framebuffer to render to.  Use nullptr to set the desired rendering 
    ...
    */
    ...
    [[deprecated]] shared_ptr<Framebuffer> framebuffer() const {
