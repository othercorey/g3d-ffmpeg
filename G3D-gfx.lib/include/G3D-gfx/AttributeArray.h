/**
  \file G3D-gfx.lib/include/G3D-gfx/AttributeArray.h
...
*/
#pragma once
#define G3D_gfx_AttributeArray_h
...
public:
    ...
    [[deprecated]] shared_ptr<VertexBuffer> area() {
        return m_area;
    }
    ...
    /** \sa buffer() \deprecated */
    [[deprecated]] inline shared_ptr<VertexBuffer> area() const {
        return m_area;
    }
    ...
    */
    ...
    /**
       ...
       \param sourcePtr The type of the data is determined from this.  If nullptr, no data is actually uploaded...but you
       must provide a properly typed pointer, e.g., (uint16*)(nullptr).
    */
    template<class T>
    ...
    */
    ...
    (const T&           ignored,
     ...
     shared_ptr<VertexBuffer>  dstPtr) {
        (void)ignored;
        init(nullptr, _numElements, dstPtr, glFormatOf(T), sizeof(T), glIsNormalizedFixedPoint(T));
    }
