/**
  \file G3D-gfx.lib/include/G3D-gfx/Framebuffer.h
...
/**
 ...
 action.  If a nullptr argument is passed to setFramebuffer, the render target
    ...
    */
    ...
    protected:
        ...
        */
        ...
        static shared_ptr<Attachment> create(AttachmentPoint ap, const shared_ptr<Texture>& r, CubeFace c, int miplevel, int layer) {
...
public:
    ...
    */
    ...
    /** Returns the attachment currently at ap, or nullptr if there is
     not one.  \sa has()*/
    ...
    /**
       ...
       to nullptr or call clear() to unset.  Auto-mipmap will
