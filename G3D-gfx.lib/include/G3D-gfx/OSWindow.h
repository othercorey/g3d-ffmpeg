/**
  \file G3D-gfx.lib/include/G3D-gfx/OSWindow.h
...
public:   
    ...
    public:
        ...
        enum API {API_OPENGL, API_OPENGL_ES, API_VULKAN};
        ...
        /** Refresh rate for full-screen, in cycles/sec. If less than or equal to, the display can choose its own refresh. */
        int     refreshRate;
...
private:
    ...
    public:
        ...
        LoopBody() : func(nullptr), arg(nullptr), isGApp(false) {}
        LoopBody(GApp* a) : app(a), arg(nullptr),  isGApp(true) {}
...
protected:
    ...
    OSWindow() : m_renderDevice(nullptr), m_inputCaptureCount(0), m_mouseHideCount(0) {}  
    ...
    /** Override this with the glMakeCurrent call appropriate for your window. Protected because user methods should call push/pop methods. */
...
public:
    ...
    */
    ...
    /** 
      ...
      returns that renderDevice.  Otherwise returns nullptr.
      */
