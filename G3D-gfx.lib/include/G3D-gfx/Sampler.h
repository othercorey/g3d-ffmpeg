/**
  \file G3D-gfx.lib/include/G3D-gfx/Sampler.h
...
public:
    ...
    /** Add to the MIP level after it is computed. >0 = make blurrier, <0 = make sharper. Default is -0.25f */
    float               mipBias;
