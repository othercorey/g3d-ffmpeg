/**
  \file G3D-gfx.lib/source/AttributeArray.cpp
...
AttributeArray::AttributeArray() : 
    m_pointer(nullptr), m_elementSize(0), 
...
AttributeArray::AttributeArray(size_t numBytes, const shared_ptr<VertexBuffer>& area) : 
    ...
    init(nullptr, (int)numBytes, area, GL_NONE, 1, false);
}
...
(const void* srcPtr,
 ...
 bool        normalizedFixedPoint) {
    ...
    // Upload the data
    if ((numElements > 0) && (srcPtr != nullptr)) {
