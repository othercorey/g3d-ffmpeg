/**
  \file G3D-gfx.lib/source/directinput8.h
...
private:
    ...
    static BOOL CALLBACK enumJoysticksCallback(LPCDIDEVICEINSTANCEA lpddi,
        ...
        if (((_DirectInput*)pvRef)->_directInput->CreateDevice(lpddi->guidInstance, &tmpInfo.device, nullptr) != S_OK) {
            return true;
        }
...
public:
    ...
    _DirectInput(HWND window) {
        ...
        if (DirectInput8Create( ::GetModuleHandle(nullptr), 
                                DIRECTINPUT_VERSION, 
                                IID_IDirectInput8A, 
    ...
    bool getJoystickState(unsigned int joystick, Array<float>& axis, Array<bool>& button, int& povDegrees) {
        ...
        debugAssert( _joysticks[joystick].device != nullptr );
