/**
  \file G3D-gfx.lib/source/DXCaps.cpp
...
uint64 DXCaps::videoMemorySize() {
    ...
    if ( !FAILED(CoCreateInstance( CLSID_DirectDraw, nullptr, CLSCTX_INPROC_SERVER, IID_IDirectDraw2, reinterpret_cast<LPVOID*>(&ddraw))) ) {
