...
otherInclude = '';
if sys.platform.startswith('darwin'): otherInclude = '/opt/local/include;'
...
# """ + configHelp + """
[GLOBAL]
defaultinclude:  $(INCLUDE);""" + otherInclude + """/usr/local/include/SDL11;/usr/include/SDL;/usr/X11R6/include;
