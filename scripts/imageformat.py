...
ImageFormat_h = os.path.join(G3D_DIR, "G3D-base.lib", "include", "G3D-base", "ImageFormat.h")
ImageFormat_cpp = os.path.join(G3D_DIR, "G3D-base.lib", "source" , "ImageFormat.cpp")
...
# SNORM types must use signed formats!
#---------------------------------------------------------------data------------------------------------------#
AllFormats = [
...
{"name":        "R11G11B10F",   "Implemented" : True, "AlphaVersion": "RGBA16F"         , "hasSRGBVersion": False, "methodData": [3, "UNCOMP_FORMAT",     "GL_R11F_G11F_B10F_EXT","GL_RGB",     0,  0, 11, 11, 10, 0, 0,   32,   32,                  "GL_UNSIGNED_INT_10F_11F_11F_REV", "OPAQUE_FORMAT", "FLOATING_POINT_FORMAT", "ImageFormat::CODE_R11G11B10F", "ImageFormat::COLOR_SPACE_RGB"]},
...
{"name":        "R8_SNORM",     "Implemented" : True, "AlphaVersion": ""                , "hasSRGBVersion": False, "methodData": [1, "UNCOMP_FORMAT",     "GL_R8_SNORM",        "GL_RED",      0,  0,  8,  0,  0,  0,  0, 8, 8,                       "GL_BYTE", "OPAQUE_FORMAT", "NORMALIZED_FIXED_POINT_FORMAT", "ImageFormat::CODE_R8_SNORM", "ImageFormat::COLOR_SPACE_RGB"]},
...
{"name":        "R16_SNORM",    "Implemented" : True, "AlphaVersion": ""                , "hasSRGBVersion": False, "methodData": [1, "UNCOMP_FORMAT",     "GL_R16_SNORM",       "GL_RED",           0,  0,  16,  0,  0,  0,  0, 16, 16,               "GL_SHORT", "OPAQUE_FORMAT", "NORMALIZED_FIXED_POINT_FORMAT", "ImageFormat::CODE_R16_SNORM", "ImageFormat::COLOR_SPACE_RGB"]},
...
{"name":        "RG8_SNORM",    "Implemented" : True, "AlphaVersion": ""                , "hasSRGBVersion": False, "methodData": [2, "UNCOMP_FORMAT",     "GL_RG8_SNORM",       "GL_RG",             0,  0,  8,  8,  0,  0,  0, 16, 16,               "GL_BYTE", "OPAQUE_FORMAT", "NORMALIZED_FIXED_POINT_FORMAT", "ImageFormat::CODE_RG8_SNORM", "ImageFormat::COLOR_SPACE_RGB"]},
...
{"name":        "RG16_SNORM",   "Implemented" : True, "AlphaVersion": ""                , "hasSRGBVersion": False, "methodData": [2, "UNCOMP_FORMAT",     "GL_RG16_SNORM",      "GL_RG",             0,  0,  16,  16,  0,  0,  0, 16*2, 16*2,         "GL_SHORT", "OPAQUE_FORMAT", "NORMALIZED_FIXED_POINT_FORMAT", "ImageFormat::CODE_RG16_SNORM", "ImageFormat::COLOR_SPACE_RGB"]},
...
#----------------------------------------------ImageFormat.h------------------------------------------#
code_h = """/**
  \\file G3D-base.lib/include/G3D-base/ImageFormat.h
...
#ifndef G3D_ImageFormat_h
#define G3D_ImageFormat_h
...
code_h += """
    ...
    /** Converts between arbitrary formats on the CPU.  Not all format conversions are supported or directly supported.
       ...
       \sa G3D::ImageConvert
    */
    [[deprecated]] static bool convert(const Array<const void*>& srcBytes, int srcWidth, int srcHeight, const ImageFormat* srcFormat, int srcRowPadBits,
    ...
    /**
       ...
       \sa G3D::ImageConvert
     */
    [[deprecated]] static bool conversionAvailable(const ImageFormat* srcFormat, int srcRowPadBits, const ImageFormat* dstFormat, int dstRowPadBits, bool invertY = false);
...
code_cpp = """
/**
  \\file G3D-base.lib/source/ImageFormat.cpp
