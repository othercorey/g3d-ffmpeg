/**
  \file G3D-app.lib/source/GuiControl.cpp
...
GuiControl::GuiControl(GuiWindow* gui, const GuiText& caption) : m_enabled(true), m_gui(gui), m_parent(nullptr), m_rect(Rect2D::xywh(0,0,0,0)), m_clickRect(Rect2D::empty()), m_visible(true) {
    m_eventSource = this;
    setCaption(caption);
}
