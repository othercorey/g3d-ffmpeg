/**
  \file G3D-app.lib/include/G3D-app/AmbientOcclusionSettings.h
...
public:
    ...
    */
    ...
    /** If true, only compute AO within a disk, for VR headsets. The exact disk radius
        is different for each framebuffer within the AmbientOcclusion pass and has
