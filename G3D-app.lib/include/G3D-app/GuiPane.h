/**
  \file G3D-app.lib/include/G3D-app/GuiPane.h
...
public:
    ...
    /** \param mouse in GUI pixels */ // TODO: make protected
    ...
    */
    virtual void beginRow() {
        ...
        m_layoutPreviousControl = nullptr;
    }
    ...
    */
    ...
    GuiTabPane* addTabPane(const Pointer<int>& currentTabID = Pointer<int>());
    ...
    */
    ...
    GuiMultiLineTextBox* addMultiLineTextBox
    (const GuiText& caption,
     const Pointer<String>& stringPointer,
     GuiTextBox::Update update = GuiTextBox::DELAYED_UPDATE,
     GuiTheme::TextBoxStyle style = GuiTheme::NORMAL_TEXT_BOX_STYLE
     ) {        
        return addControl(new GuiMultiLineTextBox(this, caption, stringPointer, update, style));
    }
    ...
    */
    ...
    GuiSlider<Value>* addSlider(const GuiText& text, 
                                ...
                                bool useLowerInf               = false,
                                bool useUpperInf               = false) {
        return addControl(new GuiSlider<Value>(this, text, value, min,  max, horizontal, scale, nullptr, useLowerInf, useUpperInf));
    }
    ...
    */
    ...
    /** 
        ...
        so that there is no wasted space. Does not affect control layout.
        Recursively packs all child GuiPane%s.
