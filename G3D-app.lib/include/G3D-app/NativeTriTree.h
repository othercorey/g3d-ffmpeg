/**
  \file G3D-app.lib/include/G3D-app/NativeTriTree.h
...
#include "G3D-base/PrecomputedRay.h"
...
private:
    ...
    private:
        ...
        /** 0 = node below split location, 1 = node above split
            location.  At an internal node, both are non-nullptr,
            at a leaf, both are nullptr. 
        */
        ...
        */
        inline void computeTraversalOrder(const PrecomputedRay& ray, int& firstChild, int& secondChild) const {
...
public:
    ...
    static shared_ptr<NativeTriTree> create() {
        return createShared<NativeTriTree>();
    }

    virtual const String& className() const override { static const String n = "NativeTriTree"; return n; }
