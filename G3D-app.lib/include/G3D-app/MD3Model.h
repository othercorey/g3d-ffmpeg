/**
  \file G3D-app.lib/include/G3D-app/MD3Model.h
...
public:
    ...
    public:
        /** Maps triList names to materials.  If a material is specified as nullptr
...
public:
     ...
     */
    void pose(Array<shared_ptr<class Surface> >& posedModelArray, const CFrame& cframe, const CFrame& previousFrame, const Pose& currentPose = Pose(), const shared_ptr<Entity>& entity = nullptr,
    ...
    void pose(Array<shared_ptr<class Surface> >& posedModelArray, const CFrame& cframe = CFrame(), const Pose& currentPose = Pose(), const shared_ptr<Entity>& entity = nullptr,
     const Surface::ExpressiveLightScatteringProperties& e = Surface::ExpressiveLightScatteringProperties()) {
        pose(posedModelArray, cframe, cframe, currentPose, entity, e);
    }
