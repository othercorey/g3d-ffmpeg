/**
  \file G3D-app.lib/include/G3D-app/SlowMesh.h
...
public:
    ...
    /** Constructs a VertexBuffer from the vertex array, and renders it using a simple shader that
        ...
        \param coverageAntialiasingMode If greater than 1, use multisampling for coverage. This only
         works with depth and stencil disabled.
     */
