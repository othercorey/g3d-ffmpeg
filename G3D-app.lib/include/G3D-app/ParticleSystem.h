/**
  \file G3D-app.lib/include/G3D-app/ParticleSystem.h
...
public:
    ...
    public:
        ...
        /** Used for simulation in some animation modes. Not mapped to the GPU.  
            ...
            \sa angularVelocity 
             Velocity or previous position will likely be mapped to the GPU in the future
...
protected:
    ...
    class SortProxy {
    public:
        /** In camera space. May not be NaN */
        float           z;
