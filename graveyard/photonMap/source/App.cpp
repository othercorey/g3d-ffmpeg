...
void App::onRenderButton() {
    ...
    // Apply Film exposure
    //TODO: double check this is right - yitong
    m_film->exposeAndRender(renderDevice, activeCamera()->filmSettings(), srcTexture, 0, settings().hdrFramebuffer.colorGuardBandThickness.x, dstTexture);
