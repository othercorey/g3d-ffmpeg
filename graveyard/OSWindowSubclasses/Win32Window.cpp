/**
  \file G3D-gfx.lib/source/Win32Window.cpp
...
static PFNWGLCREATECONTEXTATTRIBSARBPROC g3d_wglCreateContextAttribsARB = nullptr;

// Deals with unicode/MBCS/char issues
static LPCTSTR toTCHAR(const String& str) {
#   if 0//if defined(_MBCS) || defined(UNICODE)
...
void Win32Window::setAsCurrentGraphicsContext() const {
